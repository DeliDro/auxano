                    ...
                    <div class="col-md-12"> 
                        <div class="title-box ttm-textcolor-white">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span style="font-weight: bold; color: white">Publications</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
                            ...
                            <div class="row no-gutters featured-imagebox featured-imagebox-post ttm-box-view-left-image box-shadow">
                                <div class="col-lg-5 col-md-12 col-sm-6 ttm-featured-img-left">
                                    <div class="featured-thumbnail"> 
                                        <img class="img-fluid" src="https://via.placeholder.com/450X600/444444.jpg" alt="image"> 
                                    </div> 
                                </div>
                                <div class="col-lg-7 col-md-12 col-sm-6 featured-content featured-content-post">
                                    ...
                                    <div class="post-title featured-title">
                                        <h5><a href="publication.php">Titre publication</a></h5>
                                    </div>
                                    <div class="featured-desc ttm-box-desc">
                                        <p>Avant-goût de publication...</p>
                                    </div>
                                    <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i>19 Mai 2021</a></span>
                        ...
                        <div class="col-lg-6 col-sm-12 col-md-6 col-xs-12">
                            ...
                            <div class="row no-gutters featured-imagebox featured-imagebox-post ttm-box-view-left-image box-shadow">
                                ...
                                <div class="col-lg-7 col-md-12 col-sm-6 featured-content featured-content-post">
                                    ...
                                    <div class="post-title featured-title">
                                        <h5><a href="publication.php">Don d'un pont au village de Kanahakiri</a></h5>
                                    </div>
                                    <div class="featured-desc ttm-box-desc">
                                        <p>Dévouvrez en images et en texte ce événement à fort impact social qui crée les conditions de développement de ce petit village du nord de la Côte d'Ivoire...</p>
                                    </div>
                                    <div class="post-meta">
                                        <span class="ttm-meta-line"><i class="fa fa-calendar"></i>19 Mai 2021</a></span>
                                        <span class="ttm-meta-line"><i class="fa fa-eye"></i>2 vues</span>
